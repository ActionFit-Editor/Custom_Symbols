...
public static class CustomSymbolsPackageMenu
{
    private const string PackageId = "com.actionfit.customsymbols";
    private const string MenuRoot = "Tools/Package/Custom Symbols/";
    private const string ReadmePath = "Packages/com.actionfit.customsymbols/README.md";
